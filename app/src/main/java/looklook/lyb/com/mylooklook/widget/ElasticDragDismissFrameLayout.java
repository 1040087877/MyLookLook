...
package looklook.lyb.com.mylooklook.widget;
...
//        Log.e(TAG, "onStartNestedScroll: "+"child = [" + child + "], target = [" + target + "], nestedScrollAxes = [" + nestedScrollAxes + "]");
...
//        Log.e(TAG, "onNestedPreScroll: "+ "target = [" + target + "], dx = [" + dx + "], dy = [" + dy + "], consumed = [" + consumed + "]");
    }
...
//        Log.e(TAG, "horizontal: "+"scroll = [" + scroll + "]");
    }
...
//        Log.e(TAG, "onNestedScroll: "+"target = [" + target + "], dxConsumed = [" + dxConsumed + "], dyConsumed = [" + dyConsumed + "], dxUnconsumed = [" + dxUnconsumed + "], dyUnconsumed = [" + dyUnconsumed + "]");
    }
...
//        Log.e(TAG, "dragScale: "+"scroll = [" + scroll + "]" );
    }
...
//        Log.e(TAG, "dispatchDragCallback: "+ "elasticOffset = [" + elasticOffset + "], elasticOffsetPixels = ["
//                + elasticOffsetPixels + "], rawOffset = [" + rawOffset + "], rawOffsetPixels = [" + rawOffsetPixels + "]");
    }
